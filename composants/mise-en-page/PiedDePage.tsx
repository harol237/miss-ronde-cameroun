...
export default function PiedDePage({ locale }: { locale: string }) {
  ...
  const legal = [
    ...
    { href: '/legal/reglement-concours', label: 'Règlement du concours' },
  ...
  const reseaux = [
    {
      nom: 'Instagram',
      href: 'https://www.instagram.com/missrondecamerounofficiel',
      sigle: 'IG',
    },
    {
      nom: 'Facebook',
      href: 'https://www.facebook.com/share/18koDeNzwe/',
      sigle: 'FB',
    },
    {
      nom: 'YouTube',
      href: 'https://youtube.com/@missrondecamerounofficiel',
      sigle: 'YT',
    },
  ]
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                  ...
                  href="mailto:missrondecameroun@gmail.com"
                  className="text-[13px] text-white/35 hover:text-[#E8C97A] transition-colors duration-200 block"
                >
              ...
              <li>
                  ...
                  href="tel:+237675238097"
                  className="text-[13px] text-white/35 hover:text-[#E8C97A] transition-colors duration-200 block"
                >
                  +237 6 75 23 80 97
                </a>
              </li>
              <li className="text-[13px] text-white/25">
                Yaoundé, Cameroun
              </li>
            </ul>
