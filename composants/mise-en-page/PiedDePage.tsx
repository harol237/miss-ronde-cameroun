        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="mailto:missrondecameroun@gmail.com" className="text-[13px] text-white/35 hover:text-[#E8C97A] transition-colors duration-200 block">missrondecameroun@gmail.com</a></li>
              <li><a href="tel:+237675238097" className="text-[13px] text-white/35 hover:text-[#E8C97A] transition-colors duration-200 block">+237 6 75 23 80 97</a></li>
