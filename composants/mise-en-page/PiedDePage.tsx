    ...
    <footer className="bg-[#111111] border-t border-[#C9A84C]/10">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-[13px] text-gray-200 leading-relaxed mb-6 max-w-[220px]">
              {t('slogan')}
            </p>
            ...
            <div className="flex gap-3 mt-6">
              {reseaux.map((r) => (
                <a key={r.nom} href={r.href} target="_blank" rel="noopener noreferrer" aria-label={r.nom}
                  className="w-9 h-9 border border-[#C9A84C]/25 flex items-center justify-center text-[11px] font-medium text-gray-200 hover:text-[#C9A84C] hover:border-[#C9A84C] transition-all duration-300">
                  {r.sigle}
                </a>
              ))}
            </div>
              ...
              {liens.map((lien) => (
                <li key={lien.href}>
                  <Link href={'/' + locale + lien.href}
                    className="text-[13px] text-gray-200 hover:text-[#E8C97A] transition-colors duration-200">
                    {lien.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="mailto:missrondecameroun@gmail.com" className="text-[13px] text-gray-200 hover:text-[#E8C97A] transition-colors duration-200 block">missrondecameroun@gmail.com</a></li>
              <li><a href="tel:+237675238097" className="text-[13px] text-gray-200 hover:text-[#E8C97A] transition-colors duration-200 block">+237 6 75 23 80 97</a></li>
              <li className="text-[13px] text-gray-300">Yaounde, Cameroun</li>
            </ul>
      ...
      <div className="border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[11px] text-gray-200 tracking-wide">{t('droits')}</p>
          <p className="text-[11px] text-gray-400 tracking-wide">missrondecameroun.cm</p>
        </div>
      </div>
    </footer>
  )
