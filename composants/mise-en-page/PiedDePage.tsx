    ...
    <footer className="bg-[#090909] border-t border-[#C9A84C]/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              {reseaux.map(function(r) { return (
                  ...
                  aria-label={r.nom}
                  className="w-9 h-9 border border-[#C9A84C]/25 flex items-center justify-center text-[11px] font-medium text-white/40 hover:text-[#C9A84C] hover:border-[#C9A84C] transition-all duration-300"
                >
                  {r.sigle}
                </a>
              )})}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {liens.map(function(lien) { return (
                <li key={lien.href}>
                  <Link
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:missrondecameroun@gmail.com" className="text-[13px] text-white/35 hover:text-[#E8C97A] transition-colors duration-200 block">
                  missrondecameroun@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+237675238097" className="text-[13px] text-white/35 hover:text-[#E8C97A] transition-colors duration-200 block">
                  +237 6 75 23 80 97
                </a>
              </li>
              <li className="text-[13px] text-white/25">Yaounde, Cameroun</li>
            </ul>
            <Link
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[11px] text-white/15 tracking-wide">{t('droits')}</p>
          <p className="text-[11px] text-white/10 tracking-wide">missrondecameroun.cm</p>
        </div>
      </div>
    </footer>
  )
